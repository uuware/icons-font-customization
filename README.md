...
- 1.1, This project (`icons-font-customization`) includes more than 26M of svgs data. You can install this project if you don't mind the large size. Once installed, it works locally and allows for fast copying of icons.<br>
